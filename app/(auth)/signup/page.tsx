            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <select 
                    id="country"
                    name="country" 
                    className="block w-full h-12 pl-10 pr-10 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white sm:text-sm transition-all outline-none appearance-none" 
                    required
                >
            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full h-12 pl-10 pr-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 sm:text-sm transition-all outline-none uppercase placeholder:normal-case"
                />
              </div>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
                 <button 
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white text-gray-700 border-2 border-gray-100 p-3 h-12 rounded-xl hover:bg-gray-50 hover:border-gray-200 transition font-bold shadow-sm"
                 >
                     {isGoogleLoading ? (
