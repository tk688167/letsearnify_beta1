    ...
    <div className="flex flex-wrap items-center gap-4 md:gap-8 px-5 py-3 bg-white/50 backdrop-blur-sm border border-gray-100 rounded-full shadow-sm mb-8 w-fit mx-auto md:mx-0">
       ...
       <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-gray-600">
             <span className="font-bold text-gray-900">{formatNumber(stats.totalUsers)}</span> Active Members
          </span>
       </div>
       ...
       <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-gray-600">
             <span className="font-bold text-gray-900">{formatCurrency(stats.totalRewards)}</span> Distributed
          </span>
       </div>
